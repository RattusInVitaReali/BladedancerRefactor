...
public class StartupBlockCard extends AbstractBlademasterCard implements StartupCard { // This card implements StartupCard, an extra 'type' of card that adds the ability to trigger at the start of combat.
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        damageAllAction(AbstractGameAction.AttackEffect.FIRE); // and allDmg is used instead of dmg.
    }
