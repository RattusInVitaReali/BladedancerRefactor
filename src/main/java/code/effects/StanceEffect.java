...
public class StanceEffect extends AbstractGameEffect {
    ...
    public StanceEffect(Color color) {
        ...
        this.durDiv2 = this.duration / 2.0F;
        this.color = color;
    ...
    public void update() {
        ...
        this.rotation = -(57.295776F * MathUtils.atan2(this.vY, this.vX)) - 0.0F;
        if (this.duration > this.durDiv2) {
            this.color.a = Interpolation.fade.apply(0.7F, 0.0F, (this.duration - this.durDiv2) / this.durDiv2);
        } else {
            this.color.a = Interpolation.fade.apply(0.0F, 0.7F, this.duration / this.durDiv2);
        }
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(ImageMaster.FROST_ACTIVATE_VFX_1, this.x, this.y, 32.0F, 32.0F, 25.0F, 128.0F, this.scale, this.scale + (this.durDiv2 * 0.4F - this.duration) * Settings.scale, this.rotation, 0, 0, 64, 64, false, false);
